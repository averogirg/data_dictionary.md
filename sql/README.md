...
Я изучала SQL на практике, ставя перед собой конкретные вопросы, на которые можно ответить с помощью данных. Все данные для анализа были взяты в папке **data** из таблицы **superstore** и связанной таблицы **supplier** Вот ключевые из них:
