...
Я изучала SQL на практике, ставя перед собой конкретные вопросы, на которые можно ответить с помощью данных. Все данные для анализа были взяты из таблицы superstore и связанной таблицы suppliers. Вот ключевые из них:
